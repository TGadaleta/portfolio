...
return (
    <>
        ...
        <div className='project-container'>
            <a href='https://tony-gadaleta-battleship.netlify.app/' target='_blank' rel='noopener noreferrer'>
            ...
            <a href='https://github.com/TGadaleta/Battleship' target='_blank' rel='noopener noreferrer'>Github Repository</a>
        </div>
    </>
)
}
